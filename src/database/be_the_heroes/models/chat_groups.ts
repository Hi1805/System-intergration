...
import type { config_chat_group, config_chat_groupId } from './config_chat_group';
...
export type chat_groupsOptionalAttributes = "id" | "for_post" | "created_at" | "updated_at";
export type chat_groupsCreationAttributes = Optional<chat_groupsAttributes, chat_groupsOptionalAttributes>;

export class chat_groups extends Model<chat_groupsAttributes, chat_groupsCreationAttributes> implements chat_groupsAttributes {
  id!: number;
  for_post?: number;
  member_uid!: string;
  group_chat_id!: string;
  ...
  setGroup_chat!: Sequelize.BelongsToSetAssociationMixin<config_chat_group, config_chat_groupId>;
