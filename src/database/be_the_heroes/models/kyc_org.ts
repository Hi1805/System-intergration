...
export type kyc_orgCreationAttributes = Optional<kyc_orgAttributes, kyc_orgOptionalAttributes>;

export class kyc_org extends Model<kyc_orgAttributes, kyc_orgCreationAttributes> implements kyc_orgAttributes {
  org_id!: number;
  document_photo!: string;
  created_at!: Date;
  update_at!: Date;
